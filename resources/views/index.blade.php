    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-md-6">
            ...
            <div class="card-body">
                ...
                <div class="col-auto">
                    <div class="btn-group">
                    <a type="button" class="avtar bg-secondary dropdown-toggle arrow-none" data-bs-toggle="dropdown"
                        aria-expanded="false">
        ...
        <div class="col-xl-4 col-md-12">
            ...
            <div class="card-body">
                ...
                <li class="list-group-item px-0">
                    ...
                    <div class="col-auto">
                        <h4 class="mb-0">$1839.00<span class="ms-2 align-top avtar avtar-xxs bg-light-success"><i
