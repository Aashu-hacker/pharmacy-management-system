            ...
            <div class="form-card_body">
              ...
              <form action="{{route('register')}}" method="post">
                ...
                <div class="text-center">
                  <div class="mb-5">
                    <h1 class="display-4 mt-0 font-weight-semi-bold">Sign Up</h1>
                ...
                <div class="form-group">
                  <label class="input-label" for="signinSrEmail">Name</label>
                  <input type="text" class="form-control" id="name" name="name" tabindex="1" placeholder="Enter Your Name" aria-label="" required data-msg="Please enter a Name.">
                </div>
                <!-- Form Group -->
                <div class="form-group">
